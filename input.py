...
convert fron lon/lat to UTM coords
	...
	Reassign x and y to be points, not lon/lat coords
...
gd.compute_bnd(bxy = [ [x1,x2, y1,y2], [ x1,x2, y1, y2] ] for each point
...
makes a grid boundary file grd.bnd in the current folder. 
