...
#Input
#-----------------------------------------------------------------------------
run='/home/bootk/schism/RUN01d/'     #run dir containing outputs
stacks=[1,72]                                    #stacks of schout_*.nc -- originally to 73, changed to 72 as per QQ's update 7-5-22 
sname='/home/bootk/Analysis/Obs/ModMon/mod_at_ps_wq_stations'                             #name for results
svars=['elev','salt','temp']        #SCHISM variables to be extracted
rvars=['elev','salt','temp']          #rename variable names 
#svars=['elev','hvel']
#rvars=['elev','hvel']
#bpfile='station_noaa_elev_nearpts.bp'  #file name of station.bp
bpfile='/home/bootk/Analysis/RUN01_qliu/station_ps_wq.bp'  #stations in the pamlico sound water quality (ps_WQ_2021.xlsx)
...
# with ibatch = 0, code will run locally
...
bp.x,bp.y=proj_pts(bp.x, bp.y,"epsg:4326","epsg:26918") #by QLiu
sindp=near_pts(c_[bp.x,bp.y],c_[gd.x,gd.y]) #by QLiu
bp.x,bp.y=gd.x[sindp],gd.y[sindp] #by QLiu
